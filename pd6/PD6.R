...
bpower(p1=0.45,p2=0.3,n=200,n1=100,n2=100,alpha=0.05) 
...
nNormal(delta1=dif,delta0=0,n=200,alpha=0.05,sided=2,sd=sqrt(var(52)),ratio=1,outtype=2) 
...
dif <- 15-qnorm(0.55)*sqrt(var(52)) -(15-qnorm(0.7)*sqrt(var(52)))
nNormal(delta1=dif/2,delta0=0,n=200,alpha=0.05,side=2,sd=sqrt(var(26)),ratio=1,outtype=2)


### ZAD 4

(dif <- 15-qnorm(0.55)*sqrt(var(26)) - 6.6) 
nNormal(delta1=dif,delta0=0,n=200,alpha=0.05,side=2,sd=sqrt(var(26)),ratio=1,outtype=2) 
